<div class="span3" >
    <div class="sidebar" >
        ...
        <ul class="widget widget-menu unstyled">
            <li><a href="<?php echo e(URL::route('account-sign-out')); ?>"><i class="menu-icon icon-wrench" style="color: white;"></i>Logout </a></li>
        </ul>
    </div>
</div><?php /**PATH C:\xampp\htdocs\Laravel-Library-Management-system-main\resources\views/layout/template_leftbar.blade.php ENDPATH**/ ?>